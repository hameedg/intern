...
const Card = (props) => {
  return (
    <>
      <div className="bg-[#fff] flex w-[100%] h-[100%] border border-solid border-[#000] rounded-[25px] pl-[3rem] pr-[2rem] pt-[2rem] pb-[2rem]">
        <div className="flex flex-col">
          ...
          <div className="mt-[0px] font-clash font-[500] text-[20px] leading-[2.4rem] tracking-[0.02em]  font-['ClashDisplay-Variable'] text-[#000]">
            {props.title1}
          </div>
